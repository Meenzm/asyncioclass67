...
# 2        | 2           | 2           |  1  |  2.0s   |  1  |  2.4s    |     |         |     |        |     |        |   2.45s  |
# 3        | 2           | 2           |  2  |  4.0s   |  1  |  2.4s    |     |         |     |        |     |        |   4.06s  |                                           
# 4        | 2           | 2           |  2  |  4.0s   |  2  |  4.8s    |     |         |     |        |     |        |   4.86s  |    
# 5        | 5           | 5           |  1  |  2.0s   |  1  |  2.4s    |  1  |  0.4s   |  1  |  3.2s  |  1  |  3.6s  |   3.63s  |     
# 10       | 5           | 5           |  2  |  4.0s   |  1  |  2.4s    |  5  |  2.0s   |  1  |  3.2s  |  1  |  3.6s  |   4.03s  |        
# 10       | 3           | 5           |  2  |  4.0s   |  2  |  4.8s    |  6  |  2.4s   |     |        |     |        |   4.86s  |   
# 10       | 10           | 5          |  2  |  4.0s   |  1  |  2.4s    |  5  |  2.0s   |  1  |  3.2s  |  1  |  3.6s  |   4.05s  | 
# +-----------------------------------------------------------------------------------------------------------------------------
# +-----------------------------------------------------------------------------------------------------------------------------